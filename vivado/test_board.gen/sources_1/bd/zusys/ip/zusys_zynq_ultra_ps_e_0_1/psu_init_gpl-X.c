...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRF_APB_DDR_CTRL_DIVISOR0                               0x7
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFD1A0080, 0x00003F07U ,0x00000700U)
    */
	PSU_Mask_Write(CRF_APB_DDR_CTRL_OFFSET, 0x00003F07U, 0x00000700U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_DERATEINT_MR4_READ_INTERVAL                        0x1a286d

    * Temperature Derate Interval Register
    * (OFFSET, MASK, VALUE)      (0XFD070024, 0xFFFFFFFFU ,0x001A286DU)
    */
	PSU_Mask_Write(DDRC_DERATEINT_OFFSET, 0xFFFFFFFFU, 0x001A286DU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * ONLY.
    *  PSU_DDRC_PWRTMG_T_DPD_X4096                                 0x2b
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070034, 0x00FFFF1FU ,0x00402B10U)
    */
	PSU_Mask_Write(DDRC_PWRTMG_OFFSET, 0x00FFFF1FU, 0x00402B10U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * d. Unit: Clocks.
    *  PSU_DDRC_RFSHTMG_T_RFC_MIN                                  0x1f

    * Refresh Timing Register
    * (OFFSET, MASK, VALUE)      (0XFD070064, 0x0FFF83FFU ,0x0005801FU)
    */
	PSU_Mask_Write(DDRC_RFSHTMG_OFFSET, 0x0FFF83FFU, 0x0005801FU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_INIT0_PRE_CKE_X1024                                0x150

    * SDRAM Initialization Register 0
    * (OFFSET, MASK, VALUE)      (0XFD0700D0, 0xC3FF0FFFU ,0x00020150U)
    */
	PSU_Mask_Write(DDRC_INIT0_OFFSET, 0xC3FF0FFFU, 0x00020150U);
/*##################################################################### */
    ...
    *  PSU_DDRC_INIT1_DRAM_RSTN_X1024                              0x23
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0700D4, 0x01FF7F0FU ,0x00230000U)
    */
	PSU_Mask_Write(DDRC_INIT1_OFFSET, 0x01FF7F0FU, 0x00230000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * ter
    *  PSU_DDRC_INIT4_EMR3                                         0x28

    * SDRAM Initialization Register 4
    * (OFFSET, MASK, VALUE)      (0XFD0700E0, 0xFFFFFFFFU ,0x00310028U)
    */
	PSU_Mask_Write(DDRC_INIT4_OFFSET, 0xFFFFFFFFU, 0x00310028U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070110, 0x1F0F0F1FU ,0x06040307U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG4_OFFSET, 0x1F0F0F1FU, 0x06040307U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_ZQCTL0_T_ZQ_LONG_NOP                               0xac
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070180, 0xF7FF03FFU ,0x80AC0006U)
    */
	PSU_Mask_Write(DDRC_ZQCTL0_OFFSET, 0xF7FF03FFU, 0x80AC0006U);
/*##################################################################### */
    ...
    * /LPDDR4 devices.
    *  PSU_DDRC_ZQCTL1_T_ZQ_SHORT_INTERVAL_X1024                   0x20b28

    * ZQ Control Register 1
    * (OFFSET, MASK, VALUE)      (0XFD070184, 0x3FFFFFFFU ,0x00920B28U)
    */
	PSU_Mask_Write(DDRC_ZQCTL1_OFFSET, 0x3FFFFFFFU, 0x00920B28U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Refresh Period
    *  PSU_DDR_PHY_PGCR2_TREFPRD                                   0x688

    * PHY General Configuration Register 2
    * (OFFSET, MASK, VALUE)      (0XFD080018, 0xFFFFFFFFU ,0x00F00688U)
    */
	PSU_Mask_Write(DDR_PHY_PGCR2_OFFSET, 0xFFFFFFFFU, 0x00F00688U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * PLL Power-Down Time
    *  PSU_DDR_PHY_PTR0_TPLLPD                                     0xac

    * PLL Gear Shift Time
    *  PSU_DDR_PHY_PTR0_TPLLGS                                     0x2ae

    * PHY Reset Time
    *  PSU_DDR_PHY_PTR0_TPHYRST                                    0x10

    * PHY Timing Register 0
    * (OFFSET, MASK, VALUE)      (0XFD080040, 0xFFFFFFFFU ,0x1580AB90U)
    */
	PSU_Mask_Write(DDR_PHY_PTR0_OFFSET, 0xFFFFFFFFU, 0x1580AB90U);
/*##################################################################### */
    ...
    * PLL Lock Time
    *  PSU_DDR_PHY_PTR1_TPLLLOCK                                   0x42f7

    * Reserved. Returns zeroes on reads.
    *  PSU_DDR_PHY_PTR1_RESERVED_15_13                             0x0

    * PLL Reset Time
    *  PSU_DDR_PHY_PTR1_TPLLRST                                    0x607

    * PHY Timing Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080044, 0xFFFFFFFFU ,0x42F70607U)
    */
	PSU_Mask_Write(DDR_PHY_PTR1_OFFSET, 0xFFFFFFFFU, 0x42F70607U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_DTPR2_TXS                                       0x41

    * DRAM Timing Parameters Register 2
    * (OFFSET, MASK, VALUE)      (0XFD080118, 0xFFFFFFFFU ,0x000F0041U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR2_OFFSET, 0xFFFFFFFFU, 0x000F0041U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080120, 0xFFFFFFFFU ,0x003E2B08U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR4_OFFSET, 0xFFFFFFFFU, 0x003E2B08U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x00170B08U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00170B08U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080190, 0xFFFFFFFFU ,0x00000028U)
    */
	PSU_Mask_Write(DDR_PHY_MR4_OFFSET, 0xFFFFFFFFU, 0x00000028U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_ZQCR_PGWAIT_FRQA                                0x6
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080680, 0xFFFFFFFFU ,0x0088CC58U)
    */
	PSU_Mask_Write(DDR_PHY_ZQCR_OFFSET, 0xFFFFFFFFU, 0x0088CC58U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_DX0GCR1_DMEN                                    0x0

    * Enables DQ corresponding to each bit in a byte
    *  PSU_DDR_PHY_DX0GCR1_DQEN                                    0xff

    * DATX8 n General Configuration Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080704, 0xFFFFFFFFU ,0x00007EFFU)
    */
	PSU_Mask_Write(DDR_PHY_DX0GCR1_OFFSET, 0xFFFFFFFFU, 0x00007EFFU);
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_DX0GCR3_DMOEMODE                                0x2

    * Enables the TE mode values for DM.
    *  PSU_DDR_PHY_DX0GCR3_DMTEMODE                                0x2

    * Enables the PDR mode values for DM.
    *  PSU_DDR_PHY_DX0GCR3_DMPDRMODE                               0x1
    ...
    * (OFFSET, MASK, VALUE)      (0XFD08070C, 0xFFFFFFFFU ,0x3F00A408U)
    */
	PSU_Mask_Write(DDR_PHY_DX0GCR3_OFFSET, 0xFFFFFFFFU, 0x3F00A408U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Enables DM pin in a byte lane
    *  PSU_DDR_PHY_DX1GCR1_DMEN                                    0x0

    * Enables DQ corresponding to each bit in a byte
    *  PSU_DDR_PHY_DX1GCR1_DQEN                                    0xff

    * DATX8 n General Configuration Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080804, 0xFFFFFFFFU ,0x00007EFFU)
    */
	PSU_Mask_Write(DDR_PHY_DX1GCR1_OFFSET, 0xFFFFFFFFU, 0x00007EFFU);
/*##################################################################### */
    ...
    * Enables the OE mode values for DM.
    *  PSU_DDR_PHY_DX1GCR3_DMOEMODE                                0x2

    * Enables the TE mode values for DM.
    *  PSU_DDR_PHY_DX1GCR3_DMTEMODE                                0x2

    * Enables the PDR mode values for DM.
    *  PSU_DDR_PHY_DX1GCR3_DMPDRMODE                               0x1
    ...
    * DATX8 n General Configuration Register 3
    * (OFFSET, MASK, VALUE)      (0XFD08080C, 0xFFFFFFFFU ,0x3F00A408U)
    */
	PSU_Mask_Write(DDR_PHY_DX1GCR3_OFFSET, 0xFFFFFFFFU, 0x3F00A408U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * DATX8 n General Configuration Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080904, 0xFFFFFFFFU ,0x00007EFFU)
    */
	PSU_Mask_Write(DDR_PHY_DX2GCR1_OFFSET, 0xFFFFFFFFU, 0x00007EFFU);
/*##################################################################### */
    ...
    * DATX8 n General Configuration Register 3
    * (OFFSET, MASK, VALUE)      (0XFD08090C, 0xFFFFFFFFU ,0x3F00A408U)
    */
	PSU_Mask_Write(DDR_PHY_DX2GCR3_OFFSET, 0xFFFFFFFFU, 0x3F00A408U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * DATX8 n General Configuration Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080A04, 0xFFFFFFFFU ,0x00007EFFU)
    */
	PSU_Mask_Write(DDR_PHY_DX3GCR1_OFFSET, 0xFFFFFFFFU, 0x00007EFFU);
/*##################################################################### */
    ...
    * DATX8 n General Configuration Register 3
    * (OFFSET, MASK, VALUE)      (0XFD080A0C, 0xFFFFFFFFU ,0x3F00A408U)
    */
	PSU_Mask_Write(DDR_PHY_DX3GCR3_OFFSET, 0xFFFFFFFFU, 0x3F00A408U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x00000400U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0xFFFFFFFFU, 0x00000400U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[26].
    *  PSU_IOU_SLCR_BANK1_CTRL4_PULL_HIGH_LOW_N_BIT_2              0
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180160, 0x03FFFFFFU ,0x03FFFFFBU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL4_OFFSET,
		0x03FFFFFFU, 0x03FFFFFBU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(0,0,0,0,3,0,0,0);
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD410010, 0x00000070U ,0x00000030U)
    */
	PSU_Mask_Write(SERDES_ICM_CFG0_OFFSET, 0x00000070U, 0x00000030U);
/*##################################################################### */
...
/*Disabling REF before dqs2dq training - DTCR0.RFSHDT=0*/
	Xil_Out32(0xFD080200U, 0x000081C7U);
	regval = Xil_In32(0xFD080030); /*PUB_PGSR0*/
...
/*Enabling REF after dqs2dq training - DTCR0.RFSHDT=8*/
	Xil_Out32(0xFD080200U, 0x800081C7U);
...
/*Vref training is complete, disabling static read mode*/
	...
	Xil_Out32(0xFD070180U, 0x00AC0006U);
