...
-- Date        : Thu Oct 10 07:04:25 2024
-- Host        : X running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/mike3/OneDrive/bex/vivado-4cdma/test_board.gen/sources_1/bd/zusys/ip/zusys_zynq_ultra_ps_e_0_1/zusys_zynq_ultra_ps_e_0_1_sim_netlist.vhdl
...
entity zusys_zynq_ultra_ps_e_0_1_zynq_ultra_ps_e_v3_4_1_zynq_ultra_ps_e is
  ...
  attribute C_DP_USE_AUDIO of zusys_zynq_ultra_ps_e_0_1_zynq_ultra_ps_e_v3_4_1_zynq_ultra_ps_e : entity is 1;
  ...
  attribute C_MAXIGP2_DATA_WIDTH of zusys_zynq_ultra_ps_e_0_1_zynq_ultra_ps_e_v3_4_1_zynq_ultra_ps_e : entity is 32;
...
architecture STRUCTURE of zusys_zynq_ultra_ps_e_0_1_zynq_ultra_ps_e_v3_4_1_zynq_ultra_ps_e is
  ...
  signal dp_audio_ref_clk_i : STD_LOGIC;
  ...
  attribute BOX_TYPE of DP_AUD_CLK_BUFG : label is "PRIMITIVE";
...
DP_AUD_CLK_BUFG: unisim.vcomponents.BUFG_PS
    generic map(
      SIM_DEVICE => "ULTRASCALE_PLUS",
      STARTUP_SYNC => "FALSE"
    )
        port map (
      I => dp_audio_ref_clk_i,
      O => dp_audio_ref_clk
    );
...
architecture STRUCTURE of zusys_zynq_ultra_ps_e_0_1 is
  ...
  attribute C_DP_USE_AUDIO : integer;
  attribute C_DP_USE_AUDIO of U0 : label is 1;
  attribute C_DP_USE_VIDEO : integer;
  ...
  attribute C_NUM_F2P_1_INTR_INPUTS : integer;
  attribute C_NUM_F2P_1_INTR_INPUTS of U0 : label is 4;
  attribute C_NUM_FABRIC_RESETS : integer;
  ...
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of U0 : label is "zusys_zynq_ultra_ps_e_0_1.hwdef";
  attribute PSS_IO : string;
 ...
 " LPDDR4_DQ31, , , INOUT, PS_DDR_DQ31_504, LPDDR4, , , ,PS_LPDDR4_DQ_OUT40|PS_LPDDR4_DQ_IN40, RTT_40, 40";
  attribute PSS_JITTER : string;
  attribute PSS_JITTER of U0 : label is "<PSS_EXTERNAL_CLOCKS><EXTERNAL_CLOCK name={PLCLK[0]} clock_external_divide={6} vco_name={IOPLL} vco_freq={3000.000} vco_internal_divide={2}/><EXTERNAL_CLOCK name={PLCLK[1]} clock_external_divide={6} vco_name={IOPLL} vco_freq={3000.000} vco_internal_divide={2}/></PSS_EXTERNAL_CLOCKS>";
  attribute PSS_POWER : string;
  attribute PSS_POWER of U0 : label is "<BLOCKTYPE name={PS8}> <PS8><FPD><PROCESSSORS><PROCESSOR name={Cortex A-53} numCores={4} L2Cache={Enable} clockFreq={1200.000000} load={0.5}/><PROCESSOR name={GPU Mali-400 MP} numCores={2} clockFreq={600.000000} load={0.5} /></PROCESSSORS><PLLS><PLL domain={APU} vco={2399.976} /><PLL domain={DDR} vco={2399.976} /><PLL domain={Video} vco={2999.970} /></PLLS><MEMORY memType={LPDDR4} dataWidth={4} clockFreq={342.857} readRate={0.5} writeRate={0.5} cmdAddressActivity={0.5} /><SERDES><GT name={PCIe} standard={} lanes={} usageRate={0.5} /><GT name={SATA} standard={} lanes={} usageRate={0.5} /><GT name={Display Port} standard={} lanes={} usageRate={0.5} />clockFreq={} /><GT name={USB3} standard={USB3.0} lanes={1}usageRate={0.5} /><GT name={SGMII} standard={SGMII} lanes={0} usageRate={0.5} /></SERDES><AFI master={2} slave={1} clockFreq={250.000} usageRate={0.5} /><FPINTERCONNECT clockFreq={400.000000} Bandwidth={Low} /></FPD><LPD><PROCESSSORS><PROCESSOR name={Cortex R-5} usage={Enable} TCM={Enable} OCM={Enable} clockFreq={500.000000} load={0.5}/></PROCESSSORS><PLLS><PLL domain={IO} vco={2999.970} /><PLL domain={RPLL} vco={2999.970} /></PLLS><CSUPMU><Unit name={CSU} usageRate={0.5} clockFreq={180} /><Unit name={PMU} usageRate={0.5} clockFreq={180} /></CSUPMU><GPIO><Bank ioBank={VCC_PSIO0} number={15} io_standard={LVCMOS 3.3V} /><Bank ioBank={VCC_PSIO1} number={26} io_standard={LVCMOS 3.3V} /><Bank ioBank={VCC_PSIO2} number={14} io_standard={LVCMOS 1.8V} /><Bank ioBank={VCC_PSIO3} number={16} io_standard={LVCMOS 3.3V} /></GPIO><IOINTERFACES> <IO name={QSPI} io_standard={} ioBank={VCC_PSIO0} clockFreq={300.000000} inputs={0} outputs={3} inouts={4} usageRate={0.5}/><IO name={NAND 3.1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={USB0} io_standard={} ioBank={VCC_PSIO2} clockFreq={250.000000} inputs={3} outputs={1} inouts={8} usageRate={0.5}/><IO name={USB1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth2} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GigabitEth3} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={GPIO 0} io_standard={} ioBank={VCC_PSIO0} clockFreq={1} inputs={0} outputs={0} inouts={15} usageRate={0.5}/><IO name={GPIO 1} io_standard={} ioBank={VCC_PSIO1} clockFreq={1} inputs={0} outputs={0} inouts={26} usageRate={0.5}/><IO name={GPIO 2} io_standard={} ioBank={VCC_PSIO2} clockFreq={1} inputs={0} outputs={0} inouts={14} usageRate={0.5}/><IO name={GPIO 3} io_standard={} ioBank={VCC_PSIO3} clockFreq={1} inputs={} outputs={} inouts={16} usageRate={0.5}/><IO name={UART0} io_standard={} ioBank={VCC_PSIO0} clockFreq={100.000000} inputs={1} outputs={1} inouts={0} usageRate={0.5}/><IO name={UART1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={I2C0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={I2C1} io_standard={} ioBank={VCC_PSIO0} clockFreq={100.000000} inputs={0} outputs={0} inouts={2} usageRate={0.5}/><IO name={SPI0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SPI1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={CAN0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={CAN1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SD0} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={SD1} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={Trace} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={TTC0} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={TTC1} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={TTC2} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={TTC3} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={PJTAG} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={DPAUX} io_standard={} ioBank={} clockFreq={} inputs={} outputs={} inouts={} usageRate={0.5}/><IO name={WDT0} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/><IO name={WDT1} io_standard={} ioBank={} clockFreq={100} inputs={0} outputs={0} inouts={0} usageRate={0.5}/></IOINTERFACES><AFI master={0} slave={0} clockFreq={333.333} usageRate={0.5} /><LPINTERCONNECT clockFreq={500.000000} Bandwidth={High} /></LPD></PS8></BLOCKTYPE>/>";
  attribute x_interface_info : string;
  attribute x_interface_info of dp_audio_ref_clk : signal is "xilinx.com:signal:clock:1.0 DP_AUD_REF_CLK CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of dp_audio_ref_clk : signal is "XIL_INTERFACENAME DP_AUD_REF_CLK, ASSOCIATED_BUSIF M_AXIS_MIXED_AUDIO, FREQ_HZ 25000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_dp_audio_ref_clk, INSERT_VIP 0";
  attribute x_interface_info of dp_m_axis_mixed_audio_tid : signal is "xilinx.com:interface:axis:1.0 M_AXIS_MIXED_AUDIO TID";
  attribute x_interface_info of dp_m_axis_mixed_audio_tready : signal is "xilinx.com:interface:axis:1.0 M_AXIS_MIXED_AUDIO TREADY";
  attribute x_interface_info of dp_m_axis_mixed_audio_tvalid : signal is "xilinx.com:interface:axis:1.0 M_AXIS_MIXED_AUDIO TVALID";
  attribute x_interface_info of dp_s_axis_audio_clk : signal is "xilinx.com:signal:clock:1.0 S_AXIS_AUDIO_CLK CLK";
  attribute x_interface_parameter of dp_s_axis_audio_clk : signal is "XIL_INTERFACENAME S_AXIS_AUDIO_CLK, ASSOCIATED_BUSIF S_AXIS_AUDIO, FREQ_HZ 25000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_dp_audio_ref_clk, INSERT_VIP 0";
  attribute x_interface_info of dp_s_axis_audio_tid : signal is "xilinx.com:interface:axis:1.0 S_AXIS_AUDIO TID";
  attribute x_interface_info of dp_s_axis_audio_tready : signal is "xilinx.com:interface:axis:1.0 S_AXIS_AUDIO TREADY";
  attribute x_interface_info of dp_s_axis_audio_tvalid : signal is "xilinx.com:interface:axis:1.0 S_AXIS_AUDIO TVALID";
  ...
  attribute x_interface_parameter of maxihpm0_fpd_aclk : signal is "XIL_INTERFACENAME M_AXI_HPM0_FPD_ACLK, ASSOCIATED_BUSIF M_AXI_HPM0_FPD, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_pl_clk1, INSERT_VIP 0";
  attribute x_interface_info of maxihpm1_fpd_aclk : signal is "xilinx.com:signal:clock:1.0 M_AXI_HPM1_FPD_ACLK CLK";
  attribute x_interface_parameter of maxihpm1_fpd_aclk : signal is "XIL_INTERFACENAME M_AXI_HPM1_FPD_ACLK, ASSOCIATED_BUSIF M_AXI_HPM1_FPD, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_pl_clk1, INSERT_VIP 0";
  attribute x_interface_info of pl_clk0 : signal is "xilinx.com:signal:clock:1.0 PL_CLK0 CLK";
  attribute x_interface_parameter of pl_clk0 : signal is "XIL_INTERFACENAME PL_CLK0, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_pl_clk0, INSERT_VIP 0";
  attribute x_interface_info of pl_clk1 : signal is "xilinx.com:signal:clock:1.0 PL_CLK1 CLK";
  attribute x_interface_parameter of pl_clk1 : signal is "XIL_INTERFACENAME PL_CLK1, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_pl_clk1, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of saxihp0_fpd_aclk : signal is "XIL_INTERFACENAME S_AXI_HP0_FPD_ACLK, ASSOCIATED_BUSIF S_AXI_HP0_FPD, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_pl_clk1, INSERT_VIP 0";
  attribute x_interface_info of dp_m_axis_mixed_audio_tdata : signal is "xilinx.com:interface:axis:1.0 M_AXIS_MIXED_AUDIO TDATA";
  attribute x_interface_parameter of dp_m_axis_mixed_audio_tdata : signal is "XIL_INTERFACENAME M_AXIS_MIXED_AUDIO, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 1, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 25000000, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_dp_audio_ref_clk, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute x_interface_info of dp_s_axis_audio_tdata : signal is "xilinx.com:interface:axis:1.0 S_AXIS_AUDIO TDATA";
  attribute x_interface_parameter of dp_s_axis_audio_tdata : signal is "XIL_INTERFACENAME S_AXIS_AUDIO, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 1, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 25000000, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_dp_audio_ref_clk, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of maxigp0_awid : signal is "XIL_INTERFACENAME M_AXI_HPM0_FPD, NUM_WRITE_OUTSTANDING 8, NUM_READ_OUTSTANDING 8, DATA_WIDTH 128, PROTOCOL AXI4, FREQ_HZ 250000000, ID_WIDTH 16, ADDR_WIDTH 40, AWUSER_WIDTH 16, ARUSER_WIDTH 16, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 1, HAS_LOCK 1, HAS_PROT 1, HAS_CACHE 1, HAS_QOS 1, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 1, MAX_BURST_LENGTH 256, PHASE 0.0, CLK_DOMAIN zusys_zynq_ultra_ps_e_0_1_pl_clk1, NUM_READ_THREADS 4, NUM_WRITE_THREADS 4, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
...
begin
U0: entity work.zusys_zynq_ultra_ps_e_0_1_zynq_ultra_ps_e_v3_4_1_zynq_ultra_ps_e
     port map (
      ...
      dp_audio_ref_clk => dp_audio_ref_clk,
      dp_aux_data_in => '0',
      ...
      dp_m_axis_mixed_audio_tdata(31 downto 0) => dp_m_axis_mixed_audio_tdata(31 downto 0),
      dp_m_axis_mixed_audio_tid => dp_m_axis_mixed_audio_tid,
      dp_m_axis_mixed_audio_tready => dp_m_axis_mixed_audio_tready,
      dp_m_axis_mixed_audio_tvalid => dp_m_axis_mixed_audio_tvalid,
      dp_s_axis_audio_clk => dp_s_axis_audio_clk,
      dp_s_axis_audio_tdata(31 downto 0) => dp_s_axis_audio_tdata(31 downto 0),
      dp_s_axis_audio_tid => dp_s_axis_audio_tid,
      dp_s_axis_audio_tready => dp_s_axis_audio_tready,
      dp_s_axis_audio_tvalid => dp_s_axis_audio_tvalid,
      dp_video_in_clk => '0',
