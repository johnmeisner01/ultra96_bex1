...
HD_PWD='C:/Users/john.meisner/Workspace/ultra96_bex/vivado/test_board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zusys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zusys_wrapper.tcl -notrace
