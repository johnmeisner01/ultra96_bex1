...
HD_PWD='C:/Users/john.meisner/Workspace/ultra96_bex/vivado/test_board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zusys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zusys_wrapper.tcl
